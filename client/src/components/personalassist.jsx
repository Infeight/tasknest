    ...
    return (
        <>
            ...
            <div className="heading">
                <h4>Level Up with the Right Support by Your Side.</h4>
                <h6>From tutors to trainers, find your perfect match.</h6>
            </div>

            <div className="homeservicescont">
                <div className="service1" onClick={handleservices}><MdOutlineFitnessCenter />Fitness Trainer</div>
                <div className="service1" onClick={handleservices}><GrYoga />Yoga Instructor</div>
                <div className="service1" onClick={handleservices}><FaPaintBrush />Art Teacher</div>
                <div className="service1" onClick={handleservices}><MdEmojiPeople />Dance Teacher</div>
                <div className="service1" onClick={handleservices}><FaMusic />Music Teacher</div>
                <div className="service1" onClick={handleservices}><GrUserExpert />Life Coach</div>
                <div className="service1" onClick={handleservices}><PiChefHatFill />Chef</div>
                <div className="service1" onClick={handleservices}><TbDental />Dentist</div>
